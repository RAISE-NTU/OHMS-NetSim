...
def generate_launch_description():
    ...
    sim_config_path = os.path.join(ohms_netsim_share_dir, 'config', 'multi_robot_sim.yaml')
    ...
    ros_gz_config = os.path.join(ohms_netsim_share_dir, 'config', 'multi_robot_ros_gz_bridge.yaml')
    ros_gz_tmp_config = os.path.join(ohms_netsim_share_dir, 'config', 'multi_robot_ros_gz_bridge_tmp.yaml')
