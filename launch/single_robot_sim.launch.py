...
def generate_launch_description():
    ...
    #print(f'Set the world (default marsyard2020), e.g. ros2 launch ohms_netsim single_robot_sim.launch.py world:=maze')
    ...
    sim_config_path = os.path.join(ohms_netsim_share_dir, 'config', 'single_robot_' + world + '_sim.yaml')
    ...
    ros_gz_config = os.path.join(ohms_netsim_share_dir, 'config', 'single_robot_ros_gz_bridge.yaml')
    if model_namespace != '':
