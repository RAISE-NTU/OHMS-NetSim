...
def generate_launch_description():
    ...
    sim_config_path = os.path.join(ohms_netsim_share_dir, 'config', 'dual_robot_ugv_ugv_' + world + '_sim.yaml')
    ...
    ros_gz_config = os.path.join(ohms_netsim_share_dir, 'config', 'dual_robot_ugv_ugv_rgbd_lidar_ros_gz_bridge.yaml') # Change here for relevant sensor config
