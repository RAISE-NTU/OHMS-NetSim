...
def generate_launch_description():
    ...
    sim_config_path = os.path.join(ohms_netsim_share_dir, 'config', 'multi_robot_2uav_2ugv_' + world + '_sim.yaml')
    ...
    ros_gz_config = os.path.join(ohms_netsim_share_dir, 'config', 'multi_robot_2uav_2ugv_rgbd_lidar_ros_gz_bridge.yaml') # Change here for relevant sensor config
